...
abstract class ViewModel
{
    ...
    SubscriptionEvent<ViewModel> _onLoaded = new SubscriptionEvent<ViewModel>();
    bool get isLoaded => _onLoaded == null;

    void whenLoaded(ViewModelMethod method)
    {
        if (_onLoaded == null)
            method(this);
        else
            _onLoaded.listen(method);
    }
