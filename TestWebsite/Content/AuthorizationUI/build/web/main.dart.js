...
if(z!=null){z.b.sIk(null)
z.RY(0)}},
fU:function(){return[this.b,this.c,this.d,this.e]},
...
this.Yl(u[v]).Uq(m)
if(x)J.Vs(z.bW("/authorizationui/images/delete{_v_}.gif","Delete",["bound-list-delete","image-button"],this.gVh(),r)).Q.setAttribute("index",C.jn.X(v))}}if(this.r){r=z.R5("list-item")
z.iX(document.createElement("div",null),null,"list-view",r)
z.bW("/authorizationui/images/add{_v_}.gif","New",["bound-list-add","image-button"],this.glY(),r)}}y=this.f
J.U2(J.O(y))
z.Uq(y)},
Uu:[function(a){var z
...
if(z!=null)z.V6(0)},"$1","glY",2,0,0]}}],["","",,E,{
"^":"",
jO:{
"^":"xt;Q,a,b,c",
jU:[function(a){var z,y
...
z.DN()
return z},
MO:[function(a){if(!this.a.fZ(J.SW(this.c)))J.fD(a)},"$1","gyt",2,0,3]}}],["","",,B,{
"^":"",
YD:{
"^":"xt;Q,a,b,c",
jU:[function(a){var z,y
...
z.DN()
return z},
ra:[function(a){if(!this.a.fZ(J.SW(this.c)))J.fD(a)},"$1","gbk",2,0,3]}}],["","",,T,{
"^":"",
L:{
"^":"du;x,y,z,ch,cx,cy,db,b,c,d,e,f,r,Q,a",
Ux:function(a,b){window.alert(b)},
Ie:function(a){this.F3(this.db.gzH(),a,this.cy)},
Vg:function(a){this.Lj(this.db.gkp(),a,this.cy)},
qo:function(a){this.Jh(this.db.gqa(),a,this.cy)},
Sy:function(){this.x=this.iX(document.createElement("div",null),["page-region","header-region"],null,null)
this.y=this.iX(document.createElement("div",null),["page-region","menu-region"],null,null)
this.z=this.iX(document.createElement("div",null),["page-region","main-region"],null,null)
this.ch=this.iX(document.createElement("div",null),["page-region","footer-region"],null,null)
var z=this.z
this.cx=this.iX(document.createElement("div",null),["page-region","nav-region"],null,z)
z=this.z
this.cy=this.iX(document.createElement("div",null),["page-region","body-region"],null,z)
this.Cb(2,"Authorization",this.x)
this.ix("Users",new T.ic(this),this.y)
this.ix("Groups",new T.MJ(this),this.y)
this.ix("Roles",new T.ff(this),this.y)
this.ix("Permissions",new T.pB(this),this.y)}},
ic:{
"^":"r:4;Q",
$1:function(a){J.U2(J.O(this.Q.cx))
return}},
MJ:{
"^":"r:4;Q",
...
"^":"",
Lh:{
"^":"jR;b,c,d,e,f,r,x,y,z,ch,cx,Q,a",
lj:[function(){J.x0(this.x,!1)
J.x0(this.y,this.d==null)
J.x0(this.z,!1)
J.x0(this.ch,!0)
J.x0(this.cx,!0)
var z=this.f
J.U2(J.O(z))
this.c.Uq(z)
this.r=null},"$0","gHN",0,0,5],
vn:function(){var z=this.r
...
this.x=this.ix("Refresh",new X.o6(this),x)
this.y=this.ix("Edit",new X.y9(this),x)
this.z=this.ix("New",new X.Oi(this),x)
this.ch=this.ix("Save",new X.fk(this),x)
this.cx=this.ix("Cancel",new X.Iq(this),x)
this.f=this.iX(document.createElement("div",null),null,null,z)
this.lj()},
static:{c5:function(a,b,c,d,e){var z=new X.Lh(b,c,d,e,null,null,null,null,null,null,null,null,null)
z.qm()
z.zg(a,b,c,d,e)
return z}}},
o6:{
...
J.U2(J.O(z))
this.c.Uq(z)
this.f=null},"$0","guL",0,0,5],
vn:function(){this.d.ie(this.guL())},
vX:function(a,b,c,d){var z,y,x
z=this.iX(document.createElement("div",null),["panel","editable-view"],null,null)
y=this.iX(document.createElement("div",null),null,null,z)
this.Cb(3,a,y)
x=this.iX(document.createElement("div",null),null,"tool-bar",y)
this.r=this.ix("Refresh",new X.jl(this),x)
this.x=this.ix("Edit",new X.TT(this),x)
this.y=this.ix("Delete",new X.ny(this),x)
this.z=this.ix("Save",new X.NV(this),x)
this.ch=this.ix("Cancel",new X.fZ(this),x)
this.b=this.iX(document.createElement("div",null),null,null,z)
this.Ou()},
static:{LP:function(a,b,c,d){var z=new X.mr(null,b,c,d,null,null,null,null,null,null,null,null)
z.qm()
z.vX(a,b,c,d)
return z}}},
jl:{
"^":"r:4;Q",
$1:function(a){this.Q.c.VD(0)
return}},
TT:{
"^":"r:4;Q",
$1:function(a){var z,y,x
...
this.c=z
this.sSW(b)},
static:{Sn:function(a,b){var z=new X.B8(null,null,null,a,null,null)
z.qm()
z.IS(a,b)
return z}}},
DA:{
...
this.d.sCI(null)
this.e.sCI(null)
this.f.sCI(null)}else{z.sCI(a.gyH())
this.c.sCI(a.gN0())
this.d.sCI(a.gO8())
this.e.sCI(a.gyH())
this.f.sCI(a.gyH())}},
...
y.sFL(x)
this.e=y
this.Bh("<p>Roles are assigned to groups to give all of the users in that group access to specific functions within the system.</p>","help-note")
this.Va("Role 1")
this.Va("Role 2")
this.Va("Role 3")
this.iX(W.U9("<hr/>",null,null),null,null,null)
y=this.jN(3,"Group permissions")
x=H.J(new V.h2(new U.q0(),null,null,null,null),[P.I])
x.sFL(y)
this.f=x
this.Bh("<p>This is a combination of all of the permissions assigned to all of the roles assigned to this group. To alter this list of permissions either add/remove roles on the group, or modify the permissions assigned to the roles.</p>","help-note")
this.Va("Permission 1")
this.Va("Permission 2")
this.Va("Permission 3")
this.sSW(a)},
static:{cr:function(a){var z=new U.IV(null,null,null,null,null,null,null,null)
z.qm()
z.T2(a)
return z}}},
tv:{
...
q0:{
"^":"r:6;",
$1:function(a){return J.WB(a," permissions")}}}],["","",,T,{
"^":"",
pi:{
"^":"jR;yH:b@,N0:c@,O8:d@,e,Q,a",
...
z=this.CS()
this.b=this.Fn(z,"Display name")
this.c=this.P3(z,"Description")
this.d=this.Fn(z,"Code name")
...
static:{Uo:function(){var z=new T.pi(null,null,null,null,null,null)
z.qm()
z.mS()
return z}}},
o9:{
...
$1:function(a){var z,y,x
z=this.Q
if(a.gcQ()){y=z.c.b.ny(this.b)
x=$.G8().Q
if(!x.gd9())H.vh(x.Pq())
x.MW(new F.Ps(y))
y.vn().ml(new N.FQ(this.a)).OA(new N.AP(z))}else J.Cd(z.b.e,J.Tf(a.Q,"error"))}},
FQ:{
"^":"r:9;Q",
...
this.b=y
this.sSW(a)},
static:{E6:function(a){var z=new O.NQ(null,null,null,null)
z.qm()
z.E1(a)
return z}}},
cu:{
...
GK:{
"^":"r:12;",
$1:function(a){var z=new B.tT(null,null,null,null,null,!0)
z.Q=C.S
z.b=N.bb()
z.c=N.bb()
z.d=N.bb()
...
static:{iu:function(a){var z=new N.R9(null,null,null,null)
z.qm()
z.TY(a)
return z}}},
i1:{
"^":"r:6;",
$1:function(a){return J.WB(a," ")}}}],["","",,B,{
"^":"",
tT:{
"^":"um;O8:b@,yH:c@,N0:d@,e,Q,a",
K4:function(){this.sk8(null)},
sk8:function(a){var z
this.e=a
z=this.b
if(a==null){z.sBQ(null)
this.b.sPG(null)
this.c.sBQ(null)
this.c.sPG(null)
this.d.sBQ(null)
this.d.sPG(null)}else{z.sBQ(new B.We(this,a))
...
break
case 3:z=6
return H.AZ(O.V7(u.e),n5,y)
case 6:t=d
s=t.gcQ()
r=u.e
if(s){q=C.xB.g("Changes to \"",r.gyH())+"\" group successfully saved"
p=C.Be}else{q=C.xB.g(C.xB.g("Changes to \"",r.gyH())+"\" group were not saved. ",J.Tf(t.Q,"error"))
p=C.Sx}z=4
break
case 5:z=a===C.S?7:9
break
case 7:z=10
return H.AZ(O.Yy(u.e),n5,y)
case 10:t=d
s=t.gcQ()
r=u.e
if(s){J.He(r,t.giP(t))
q=C.xB.g("New \"",u.e.gyH())+"\" group successfully added"
p=C.Be}else{q=C.xB.g(C.xB.g("New \"",r.gyH())+"\" group was not added. ",J.Tf(t.Q,"error"))
p=C.Sx}z=8
break
case 9:if(a===C.BC){p=C.Sx
q="Deleting groups requires another group to assign the users to"}else{q=C.xB.g("There were no changes to the \"",u.e.gyH())+"\" group to save"
p=C.Ub}case 8:case 4:if(b){s=$.SH().Q
if(!s.gd9())H.vh(s.Pq())
else ;s.MW(q)}else ;x=p
z=1
break
case 1:return H.AZ(x,0,y,null)
case 2:return H.AZ(v,1,y)}}return H.AZ(null,n5,y,null)},
X:function(a){return J.Lz(this.e)}},
We:{
"^":"r:14;Q,a",
...
for(z=this.Q,y=z.length,x=J.Y(a),w=0;w<z.length;z.length===y||(0,H.U)(z),++w){v=z[w]
J.hv(x.gwd(a),v)}},
Qv:function(a){var z,y,x,w
for(z=a.Q,y=z.length,x=0;x<z.length;z.length===y||(0,H.U)(z),++x){w=z[x]
...
if(b!=null)for(z=b.length,y=J.Y(a),x=0;x<b.length;b.length===z||(0,H.U)(b),++x){w=b[x]
...
"^":"",
Q:{
"^":"du;x,y,z,b,c,d,e,f,r,Q,a",
Ie:function(a){this.F3(this.z.gzH(),a,this.y)},
Vg:function(a){this.Lj(this.z.gkp(),a,this.y)},
qo:function(a){this.Jh(this.z.gqa(),a,this.y)},
Z:function(){this.x=this.iX(document.createElement("div",null),["page-region","menu-region"],null,null)
this.y=this.iX(document.createElement("div",null),["page-region","nav-region"],null,null)
this.ix("Users",new E.WW(this),this.x)
this.ix("Groups",new E.Ky(this),this.x)
this.ix("Roles",new E.XM(this),this.x)
this.ix("Permissions",new E.K6(this),this.x)}},
WW:{
"^":"r:4;Q",
$1:function(a){J.U2(J.O(this.Q.y))
return}},
Ky:{
"^":"r:4;Q",
$1:function(a){var z=this.Q
...
ZC:function(){var z=0,y=new P.Zh(),x,w=2,v,u=this,t,s,r,q,p,o
function ZC(a,b){if(a===1){v=b
z=w}while(true)switch(z){case 0:t=u.f,s=t.length,r=C.Be,q=0
case 3:if(!(q<t.length)){z=5
break}p=t[q]
z=6
return H.AZ(p.n5(p.LA(),!1),ZC,y)
case 6:o=b
if(J.mG(o,C.Sx))r=o
else ;case 4:t.length===s||(0,H.U)(t),++q
z=3
break
case 5:x=r
z=1
...
for(z=this.f,y=z.length,x=0;x<z.length;z.length===y||(0,H.U)(z),++x)if(z[x].LA()!==C.zg)return C.oQ
return C.zg},
...
if(z==null){z=Y.O2(a)
y=S.fG(a)
x=new F.P3(null,null,null,null)
x.qm()
x.b=H.Go(x.Qv(K.wg()),"$isPw")
x.c=a
x=X.c5("Permissions",a,z,y,x)
this.b=x
z=x}else{z.b=a
H.Go(z.c,"$isWG").sSW(a)
H.Go(this.b.d,"$isJ9").sSW(a)
z=this.b
H.Go(z.e,"$isP3").c=a}z.toString
J.U2(J.O(b))
z.Uq(b)},
re:function(a,b){var z,y
z=this.c
if(z==null){z=O.E6(a)
y=new N.X0(null,null,null,null)
y.qm()
y.b=H.Go(y.Qv(T.Uo()),"$ispi")
y.c=a
...
if(z==null){z=Y.Um(a)
y=O.hb(a)
x=new T.aD(null,null,null,null)
x.qm()
x.b=H.Go(x.Qv(K.eS()),"$isBr")
x.c=a
x=X.c5("Roles",a,z,y,x)
this.d=x
z=x}else{z.b=a
H.Go(z.c,"$ispp").sSW(a)
H.Go(this.d.d,"$isKj").sSW(a)
z=this.d
H.Go(z.e,"$isaD").c=a}z.toString
J.U2(J.O(b))
z.Uq(b)},
F3:function(a,b,c){var z,y,x,w,v
z=this.e
if(z==null){z=U.cr(b)
y=new Z.Mx(null,null,null,null,null,null)
y.qm()
...
y.d=v
y.sSW(b)
this.e=X.LP("Group",z,y,X.Sn(a,b))}else{H.Go(z.c,"$isIV").sSW(b)
H.Go(this.e.d,"$isMx").sSW(b)
H.Go(this.e.e,"$isB8").sSW(b)}z=this.e
z.toString
J.U2(J.O(c))
z.Uq(c)},
...
z=this.f
if(z==null){z=G.Ap(b)
y=new F.DX(null,null,null,null,null,null)
y.qm()
...
y.d=v
y.sSW(b)
this.f=X.LP("Role",z,y,N.OS(a,b))}else{H.Go(z.c,"$isyb").sSW(b)
H.Go(this.f.d,"$isDX").sSW(b)
H.Go(this.f.e,"$isk9").sSW(b)}z=this.f
z.toString
J.U2(J.O(c))
z.Uq(c)},
Jh:function(a,b,c){var z,y,x,w,v,u
z=this.r
if(z==null){z=new G.ry(null,null,null,null,null,null,null)
z.qm()
z.Bh("<p>A <b>Permission</b> is something that is tested by the system before allowing access to a specific feature. For example when the logged on user invokes the \"delete order\" feature the system will check that the user has permission to delete orders before continuing.</p>","help-note")
y=z.CS()
x=z.xo(y,"Display name")
w=H.J(new V.h2(null,null,null,null,null),[P.I])
w.sFL(x)
z.b=w
w=z.xo(y,"Description")
x=H.J(new V.h2(null,null,null,null,null),[P.I])
x.sFL(w)
z.c=x
x=z.xo(y,"Code name")
...
w.sFL(x)
z.d=w
w=z.xo(y,"Resource expression")
x=H.J(new V.h2(null,null,null,null,null),[P.I])
x.sFL(w)
z.e=x
z.Bh("<p>When the system tests if the user has a specific permission it is usually in the context of a protected resource. When you create permissions here you can optionally specify a resource expression, in which case the user is only granted this permission on resources that match the resource expression.</p>","help-note")
z.iX(W.U9("<hr/>",null,null),null,null,null)
z.jN(3,"Permission roles")
z.Bh("<p>These are the roles that grant this permission If you modify this permission then groups that have any of these roles assigned to them will be affacted.</p>","help-note")
z.Va("Role 1")
z.Va("Role 2")
z.Va("Role 3")
z.sSW(b)
x=new E.NE(null,null,null,null,null,null,null)
x.qm()
v=H.Go(x.Qv(K.wg()),"$isPw")
w=v.b
u=H.J(new B.YD(null,null,null,null),[P.I])
u.sFL(w)
x.b=u
u=v.c
w=H.J(new E.jO(null,null,null,null),[P.I])
...
x.e=w
x.sSW(b)
this.r=X.LP("Permission",z,x,D.ZI(a,b))}else{H.Go(z.c,"$isry").sSW(b)
H.Go(this.r.d,"$isNE").sSW(b)
H.Go(this.r.e,"$isMy").sSW(b)}z=this.r
z.toString
J.U2(J.O(c))
z.Uq(c)},
...
Zb:{
"^":"r:6;Q",
$1:function(a){return this.Q.qo(a.gfQ())}}}],["","",,D,{
"^":"",
My:{
"^":"pS;b,c,d,e,Q,a",
sSW:function(a){var z
...
this.c=z
this.sSW(b)},
static:{ZI:function(a,b){var z=new D.My(null,null,null,a,null,null)
z.qm()
z.pr(a,b)
return z}}},
Q6:{
...
this.c.sCI(null)
this.d.sCI(null)
this.e.sCI(null)}else{z.sCI(a.gyH())
this.c.sCI(a.gN0())
this.d.sCI(a.gO8())
this.e.sCI(a.gxI())}},
...
this.c=this.P3(z,"Description")
this.d=this.Fn(z,"Code name")
this.e=this.Fn(z,"Resource expression")
this.f=this.Bh("","validation-error")
y=this.Bh("","help-note")
x=J.fR(this.b)
...
static:{wg:function(){var z=new K.Pw(null,null,null,null,null,null,null)
z.qm()
z.Kt()
return z}}},
Jc:{
...
ie:function(a){this.c.vn().ml(new S.By(a))},
...
this.b=y
this.sSW(a)},
static:{fG:function(a){var z=new S.J9(null,null,null,null)
z.qm()
z.f0(a)
return z}}},
wl:{
...
if(!x.gd9())H.vh(x.Pq())
x.MW(new F.kl(y))
y.vn().ml(new F.Ys(this.a)).OA(new F.wu(z))}else J.Cd(z.b.f,J.Tf(a.Q,"error"))}},
Ys:{
"^":"r:9;Q",
$1:function(a){return this.Q.$0()}},
wu:{
...
this.b=y
this.sSW(a)},
static:{O2:function(a){var z=new Y.WG(null,null,null,null)
z.qm()
z.GN(a)
return z}}},
hF:{
...
this.d.sPG(null)
this.e.sBQ(null)
this.e.sPG(null)}else{z.sBQ(new O.yX(this,a))
...
break
case 3:z=6
return H.AZ(O.Z3(u.f),n5,y)
case 6:t=d
s=t.gcQ()
r=u.f
if(s){q=C.xB.g("Changes to \"",r.gyH())+"\" permission successfully saved"
p=C.Be}else{q=C.xB.g(C.xB.g("Changes to \"",r.gyH())+"\" permission were not saved. ",J.Tf(t.Q,"error"))
p=C.Sx}z=4
break
case 5:z=a===C.S?7:9
break
case 7:z=10
return H.AZ(O.hr(u.f),n5,y)
case 10:t=d
s=t.gcQ()
r=u.f
if(s){J.He(r,t.giP(t))
q=C.xB.g("New \"",u.f.gyH())+"\" permission successfully added"
p=C.Be}else{q=C.xB.g(C.xB.g("New \"",r.gyH())+"\" permission was not added. ",J.Tf(t.Q,"error"))
p=C.Sx}z=8
break
case 9:s=u.f
z=a===C.BC?11:13
break
case 11:z=14
return H.AZ(O.hI(J.lf(s)),n5,y)
case 14:t=d
s=t.gcQ()
r=u.f
if(s){q=C.xB.g("The \"",r.gyH())+"\" permission was successfully deleted"
p=C.Be}else{q=C.xB.g(C.xB.g("The \"",r.gyH())+"\" permission was not deleted. ",J.Tf(t.Q,"error"))
p=C.Sx}z=12
break
case 13:q=C.xB.g("There were no changes to the \"",s.gyH())+"\" permission to save"
p=C.Ub
case 12:case 8:case 4:if(b){s=$.SH().Q
if(!s.gd9())H.vh(s.Pq())
else ;s.MW(q)}else ;x=p
z=1
break
...
this.c=z
this.sSW(b)},
static:{OS:function(a,b){var z=new N.k9(null,null,null,a,null,null)
z.qm()
z.H5(a,b)
return z}}},
H3:{
...
this.f.sCI(null)
this.r.sCI(null)
this.x.sCI(null)}else{z.sCI(a.gyH())
this.c.sCI(a.gN0())
this.d.sCI(a.gO8())
this.e.sCI(a.gyH())
this.f.sCI(a.gyH())
...
this.Va("Group 3")
this.iX(W.U9("<hr/>",null,null),null,null,null)
x=this.jN(3,"Role permissions")
y=H.J(new V.h2(new G.NK(),null,null,null,null),[P.I])
y.sFL(x)
this.r=y
y=this.Bh("","help-note")
...
this.Va("Permission 3")
this.sSW(a)},
static:{Ap:function(a){var z=new G.yb(null,null,null,null,null,null,null,null,null,null)
z.qm()
z.ii(a)
return z}}},
Wc:{
...
fo:{
"^":"r:6;",
$1:function(a){return C.xB.g("<p>These are the permissions that will be granted when the \"",a)+"\" role is assigned to a group of users.</p>"}}}],["","",,K,{
"^":"",
Br:{
"^":"jR;yH:b@,N0:c@,O8:d@,e,Q,a",
...
static:{eS:function(){var z=new K.Br(null,null,null,null,null,null)
z.qm()
z.Nm()
return z}}},
Fz:{
...
ie:function(a){this.c.vn().ml(new O.KE(a))},
CF:function(a){this.c.CY()
a.$0()},
...
this.b=y
this.sSW(a)},
static:{hb:function(a){var z=new O.Kj(null,null,null,null)
z.qm()
z.a9(a)
return z}}},
bc:{
...
if(!x.gd9())H.vh(x.Pq())
x.MW(new F.xO(y))
y.vn().ml(new T.hz(this.a)).OA(new T.Ed(z))}else J.Cd(z.b.e,J.Tf(a.Q,"error"))}},
hz:{
"^":"r:9;Q",
$1:function(a){return this.Q.$0()}},
Ed:{
...
this.b=y
this.sSW(a)},
static:{Um:function(a){var z=new Y.pp(null,null,null,null)
z.qm()
z.uR(a)
return z}}},
hU:{
...
static:{tb:function(a){var z=new F.wW(null,null,null,null)
z.qm()
z.Yh(a)
return z}}},
xX:{
...
this.c.sPG(null)
this.e.sBQ(null)
this.e.sPG(null)}else{z.sBQ(new T.Gw(this,a))
this.b.sPG(new T.PD(a))
this.c.sBQ(new T.fn(this,a))
this.c.sPG(new T.a3(a))
this.e.sBQ(new T.Sh(this,a))
this.e.sPG(new T.Tr(a))}this.RY(0)},
hK:function(){return[]},
VD:function(a){var z=this.f
...
s=t.gcQ()
r=u.f
if(s){q=C.xB.g("Changes to \"",r.gyH())+"\" role successfully saved"
p=C.Be}else{q=C.xB.g(C.xB.g("Changes to \"",r.gyH())+"\" role were not saved. ",J.Tf(t.Q,"error"))
p=C.Sx}z=4
break
case 5:z=a===C.S?7:9
break
...
r=u.f
if(s){J.He(r,t.giP(t))
q=C.xB.g("New \"",u.f.gyH())+"\" role successfully added"
p=C.Be}else{q=C.xB.g(C.xB.g("New \"",r.gyH())+"\" role was not added. ",J.Tf(t.Q,"error"))
p=C.Sx}z=8
break
case 9:s=u.f
z=a===C.BC?11:13
break
case 11:z=14
return H.AZ(O.cG(J.lf(s)),n5,y)
case 14:t=d
s=t.gcQ()
r=u.f
if(s){q=C.xB.g("The \"",r.gyH())+"\" role was successfully deleted"
p=C.Be}else{q=C.xB.g(C.xB.g("The \"",r.gyH())+"\" role was not deleted. ",J.Tf(t.Q,"error"))
p=C.Sx}z=12
break
case 13:q=C.xB.g("There were no changes to the \"",s.gyH())+"\" role to save"
p=C.Ub
case 12:case 8:case 4:if(b){s=$.SH().Q
if(!s.gd9())H.vh(s.Pq())
else ;s.MW(q)}else ;x=p
...
z=3
return H.AZ(W.Kn(C.xB.g($.B2+"/permission/",J.Lz(a)),null,null),Ii,y)
case 3:u=q.kV(c)
t=new V.V5(null,null,null)
t.cD(0,u)
if(!J.mG(J.Tf(t.Q,"result"),"Success")){s=$.SH()
...
return H.AZ(W.GN($.B2+"/validate/permission","POST","application/json",null,null,null,C.xr.KP(a.ghJ()),null),qL,y)
case 3:u=c
t=J.Y(u)
...
z=w}while(true)switch(z){case 0:z=3
return H.AZ(W.GN($.B2+"/permissions","POST","application/json",null,null,null,C.xr.KP(a.ghJ()),null),hr,y)
case 3:u=c
t=J.Y(u)
...
z=w}while(true)switch(z){case 0:z=3
return H.AZ(W.GN(C.xB.g($.B2+"/permission/",J.Lz(J.lf(a))),"PUT","application/json",null,null,null,C.xr.KP(a.ghJ()),null),Z3,y)
case 3:u=c
t=J.Y(u)
...
hI:function(a){var z=0,y=new P.Zh(),x,w=2,v,u,t,s
function hI(b,c){if(b===1){v=c
z=w}while(true)switch(z){case 0:z=3
return H.AZ(W.GN(C.xB.g($.B2+"/permission/",J.Lz(a)),"DELETE","application/json",null,null,null,null,null),hI,y)
case 3:u=c
t=J.Y(u)
...
break
case 1:return H.AZ(x,0,y,null)
case 2:return H.AZ(v,1,y)}}return H.AZ(null,hI,y,null)},
kS:function(){var z=0,y=new P.Zh(),x,w=2,v,u,t,s,r,q,p,o,n
function kS(a,b){if(a===1){v=b
z=w}while(true)switch(z){case 0:n=C.xr
z=3
return H.AZ(W.Kn($.B2+"/roles",null,null),kS,y)
case 3:u=n.kV(b)
t=new V.V5(null,null,null)
t.cD(0,u)
if(!J.mG(J.Tf(t.Q,"result"),"Success")){s=$.SH()
...
z=w}while(true)switch(z){case 0:q=C.xr
z=3
return H.AZ(W.Kn(C.xB.g($.B2+"/role/",J.Lz(a)),null,null),HD,y)
case 3:u=q.kV(c)
t=new V.V5(null,null,null)
t.cD(0,u)
if(!J.mG(J.Tf(t.Q,"result"),"Success")){s=$.SH()
...
z=w}while(true)switch(z){case 0:z=3
return H.AZ(W.GN($.B2+"/validate/role","POST","application/json",null,null,null,C.xr.KP(a.ghJ()),null),GG,y)
case 3:u=c
t=J.Y(u)
...
z=w}while(true)switch(z){case 0:z=3
return H.AZ(W.GN($.B2+"/roles","POST","application/json",null,null,null,C.xr.KP(a.ghJ()),null),tW,y)
case 3:u=c
t=J.Y(u)
...
z=w}while(true)switch(z){case 0:z=3
return H.AZ(W.GN(C.xB.g($.B2+"/role/",J.Lz(J.lf(a))),"PUT","application/json",null,null,null,C.xr.KP(a.ghJ()),null),JW,y)
case 3:u=c
t=J.Y(u)
...
z=w}while(true)switch(z){case 0:z=3
return H.AZ(W.GN(C.xB.g($.B2+"/role/",J.Lz(a)),"DELETE","application/json",null,null,null,null,null),cG,y)
case 3:u=c
t=J.Y(u)
...
z=w}while(true)switch(z){case 0:n=C.xr
z=3
return H.AZ(W.Kn($.B2+"/groups",null,null),Rj,y)
case 3:u=n.kV(b)
t=new V.V5(null,null,null)
t.cD(0,u)
if(!J.mG(J.Tf(t.Q,"result"),"Success")){s=$.SH()
...
z=w}while(true)switch(z){case 0:q=C.xr
z=3
return H.AZ(W.Kn(C.xB.g($.B2+"/group/",J.Lz(a)),null,null),DJ,y)
case 3:u=q.kV(c)
t=new V.V5(null,null,null)
t.cD(0,u)
if(!J.mG(J.Tf(t.Q,"result"),"Success")){s=$.SH()
...
z=w}while(true)switch(z){case 0:z=3
return H.AZ(W.GN($.B2+"/validate/group","POST","application/json",null,null,null,C.xr.KP(a.ghJ()),null),RC,y)
case 3:u=c
t=J.Y(u)
...
z=w}while(true)switch(z){case 0:z=3
return H.AZ(W.GN($.B2+"/groups","POST","application/json",null,null,null,C.xr.KP(a.ghJ()),null),Yy,y)
case 3:u=c
t=J.Y(u)
...
z=w}while(true)switch(z){case 0:z=3
return H.AZ(W.GN(C.xB.g($.B2+"/group/",J.Lz(J.lf(a))),"PUT","application/json",null,null,null,C.xr.KP(a.ghJ()),null),V7,y)
case 3:u=c
t=J.Y(u)
...
break
case 1:return H.AZ(x,0,y,null)
case 2:return H.AZ(v,1,y)}}return H.AZ(null,V7,y,null)}}],["","",,N,{
"^":"",
aA:{
"^":"fe;Q,a,b,c,d,e",
...
else ;k.O7()}else ;case 18:case 15:n.length===o||(0,H.U)(n),++r
z=14
break
...
if(v!=null&&v.length>0)for(z=v.length,x=0;x<v.length;v.length===z||(0,H.U)(v),++x){u=v[x]
...
U:function(a){throw H.b(new P.UV(a))},
...
self.scheduleImmediate(H.tR(new P.C6(a),0))},"$1","vd",2,0,37],
...
$.mg=null
$.UD=!1
if($.S6!=null)$.ej().$1(P.M7())}},"$0","M7",0,0,5],
...
QE:[function(a){},"$1","QN",2,0,38],
Z0:[function(a,b){var z=$.X3
z.toString
P.L2(null,null,z,a,b)},function(a){return P.Z0(a,null)},"$2","$1","bx",2,2,28,0],
...
$.X3.toString
this.ZL(a,b)},function(a){return this.w0(a,null)},"pm","$2","$1","gYJ",2,2,27,0]},
Lj:{
"^":"Pf;Q",
...
P.HZ(this,z)},function(a){return this.ZL(a,null)},"yk","$2","$1","gFa",2,2,28,0],
Xf:function(a){var z
...
return}this.Q.zd(0)
this.b=new P.OH(a,b)
this.c=4},function(a){return this.d8(a,null)},"oG","$2","$1","gTv",2,2,27,0],
...
Yg:[function(a,b){this.UI(a,b)},"$2","gPr",4,0,31],
...
Ou:[function(a,b){return J.mG(a,b)},"$2","iv",4,0,39],
T9:[function(a){return J.v1(a)},"$1","rm",2,0,40],
...
tp:[function(a){return a.Lt()},"$1","DY",2,0,41],
uw:{
"^":"a;Q,a,b",
...
"^":"a;dA:Q<",
aN:function(a,b){var z,y,x,w
for(z=this.gvc(),y=z.length,x=0;x<z.length;z.length===y||(0,H.U)(z),++x){w=z[x]
b.$2(w,this.p(0,w))}},
...
for(y=this.Q.className.split(" "),x=y.length,w=0;w<y.length;y.length===x||(0,H.U)(y),++w){v=J.fP(y[w])
...
if(z==null)return y
for(x=z.split(" "),w=x.length,v=0;v<x.length;x.length===w||(0,H.U)(x),++v){u=J.fP(x[v])
...
$.M=z
y=new K.V(null,null,null,null,null,!0)
y.Q=C.S
$.N=y
z=C.CD.zQ(z.clientWidth)
y=$.N
if(z>500){z=new T.L(null,null,null,null,null,null,y,null,null,null,null,null,null,null,null)
z.qm()
z.N8()
z.Sy()
z.yy(y.gqa(),z.cx)
$.P=z}else{z=new E.Q(null,null,y,null,null,null,null,null,null,null,null)
z.qm()
z.N8()
z.Z()
z.yy(y.gqa(),z.y)
...
if(a instanceof P.a)return a
return J.ks(a)}
J.As=function(a,b){return J.Y(a).smN(a,b)}
...
J.Cd=function(a,b){return J.Y(a).shf(a,b)}
...
J.He=function(a,b){return J.Y(a).siP(a,b)}
J.In=function(a){return J.Y(a).gns(a)}
J.LE=function(a){return J.Y(a).VD(a)}
J.Lp=function(a,b){return J.Y(a).st5(a,b)}
...
J.Nn=function(a){return J.Y(a).bI(a)}
...
J.QV=function(a,b){return J.Y(a).srZ(a,b)}
...
J.kz=function(a){return J.Y(a).bS(a)}
J.lX=function(a,b){if(typeof a=="number"&&typeof b=="number")return a*b
return J.Qc(a).R(a,b)}
J.lf=function(a){return J.Y(a).giP(a)}
...
J.wH=function(a,b){return J.Y(a).sM(a,b)}
J.wS=function(a){return J.U6(a).gv(a)}
J.x0=function(a,b){return J.Y(a).snf(a,b)}
J.yn=function(a){return J.Y(a).RY(a)}
J.zj=function(a){return J.Y(a).gvH(a)}
